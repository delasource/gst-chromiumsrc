...
| `cef_render_handler.cpp` | CEF integration: lifecycle and frame buffer                     |
| `cef_manager.h`          | CEF manager declarations                                        |
| `cef_manager.cpp`        | CEF integration: browser setup for reusability                  |
