...
static void gst_chromium_src_class_init(GstChromiumSrcClass *klass) {
    ...
    g_object_class_install_property(gobject_class, PROP_DISABLE_GPU,
        g_param_spec_boolean("disable-gpu", "Disable GPU",
...
static void gst_chromium_src_set_property(
    ...
    switch (prop_id) {
        ...
        case PROP_DISABLE_GPU:
            src->gpu_user_specified = TRUE;
            src->gpu_enabled = !g_value_get_boolean(value);
            break;
        default:
...
static void gst_chromium_src_get_property(GObject *object,
    ...
    switch (prop_id) {
        ...
        case PROP_DISABLE_GPU:
            g_value_set_boolean(value, !src->gpu_enabled);
            break;
        default:
            G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec);
            break;
