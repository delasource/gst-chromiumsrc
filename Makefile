...
# Build Targets
SOURCES = gstchromiumsrc.cpp cef_render_handler.cpp cef_manager.cpp gpu_utils.cpp
...
$(PLUGIN): $(SOURCES) gstchromiumsrc.h cef_render_handler.h cef_manager.h gpu_utils.h
